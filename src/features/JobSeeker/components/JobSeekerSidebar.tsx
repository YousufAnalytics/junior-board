...
import type JobSeekerDashboard from "../pages/JobSeekerDashboard";

const navItems = [
  { label: "Dashboard", path: "/dashboard", icon :  <LayoutDashboard /> },
  { label: "Jobs", path: "/applications", icon : <ClipboardList /> },
  { label: "Applications", path: "/applications", icon : <ClipboardList /> },
  { label: "Resume Builder", path: "/applications", icon : <ClipboardList /> },
];
